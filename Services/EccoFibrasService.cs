...
public class EccoFibrasService
{
    ...
    public async Task<Dictionary<string, object>> AlterarResponsavelAsync()
    {
        ...
        var updates = new List<(int opportunityId, int responsableId, string nomeResponsavel, Dictionary<string, JsonElement> formsData)>();
        ...
        foreach (var pipelineId in PipelineIds)
        {
            foreach (var stageId in StageIds)
            {
                ...
                foreach (var opp in opportunities.OrderByDescending(o => o.Id))
                {
                    ...
                    updates.Add((opportunityId, responsableId, nomeResponsavel, opp.FormsData ?? new Dictionary<string, JsonElement>()));
